...
def filter_singleton_classes(df_pam50, df_meth, df_atac=None, min_class_size=2):
    ...
    if small_classes:
        ...
        if df_atac is not None:
            # Handle both index=patient_barcode and columns=patient_barcode orientations
            if set(df_pam50.index).issubset(set(df_atac.index)):
                ...
                # Intersect with surviving barcodes
...
if __name__ == "__main__":
    # Self-test on fixture matching the reported real cohort
