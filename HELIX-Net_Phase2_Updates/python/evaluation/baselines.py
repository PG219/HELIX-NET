...
def run_baselines():
    ...
    print("\n" + "="*50)
    print("Baseline Evaluation Results (Synthetic Data)")
    print("NOTE: Performance numbers are functionally meaningless ")
    print("on random synthetic data and are just to check pipeline mechanics.")
    print("="*50)
